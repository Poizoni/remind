 ...
 * @author Shai Almog
 */
public class RemindStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Remind";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new RemindStub());
    }
